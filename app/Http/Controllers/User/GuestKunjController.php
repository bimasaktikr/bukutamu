...
class GuestKunjController extends Controller
{
    //
    public function formTamu() {
        ...
        return view('/indexkunj', compact('job','education','media','service','sub_categories','categories','purpose', 'tujuankunjungan', 'pegawai'));
