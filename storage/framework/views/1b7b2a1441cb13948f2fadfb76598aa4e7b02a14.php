...
<head>
  ...
  <!-- Vendor CSS Files -->
  <link href="<?php echo e(asset('template/assets/vendor/aos/aos.css')); ?>" rel="stylesheet">
  <link href="<?php echo e(asset('template/assets/vendor/bootstrap/css/bootstrap.min.css')); ?>" rel="stylesheet">
  <link href="<?php echo e(asset('template/assets/vendor/bootstrap-icons/bootstrap-icons.css')); ?>" rel="stylesheet">
  <link href="<?php echo e(asset('template/assets/vendor/boxicons/css/boxicons.min.css')); ?>" rel="stylesheet">
  <link href="<?php echo e(asset('template/assets/vendor/glightbox/css/glightbox.min.css')); ?>" rel="stylesheet">
  <link href="<?php echo e(asset('template/assets/vendor/remixicon/remixicon.css')); ?>" rel="stylesheet">
  <link href="<?php echo e(asset('template/assets/vendor/swiper/swiper-bundle.min.css')); ?>" rel="stylesheet">
...
<body>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="order-1 col-lg-6 order-lg-2 hero-img" data-aos="zoom-in" data-aos-delay="200">
          <img src="<?php echo e(asset('template/assets/img/hero-img.png')); ?>" class="img-fluid animated" alt="">
        </div>
      </div>
    </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-6 d-flex align-items-center" data-aos="fade-right" data-aos-delay="100">
            <img src="<?php echo e(asset('template/assets/img/skills.png')); ?>" class="img-fluid" alt="">
          </div>
                  ...
                  <div class="card-body">
                    <div class="row no-gutters align-items-center">
                      <div class="mr-2 col">
                        ...
                        <div class="mb-0 text-gray-800 h5 font-weight"><strong><?php echo e($customer); ?></strong> orang</div>
                      </div>
                      <div class="col-auto">
                    ...
                    <div class="row no-gutters align-items-center">
                      <div class="mr-2 col">
                        <div class="mb-1 text-sm font-weight-bold text-success text-uppercase">
                          ASN</div>
                        <div class="mb-0 text-gray-800 h5 font-weight"><strong><?php echo e($asn); ?></strong> orang</div>
                      </div>
                      <div class="col-auto">
                  ...
                  <div class="card-body">
                    <div class="row no-gutters align-items-center">
                      <div class="mr-2 col">
                        ...
                        <div class="row no-gutters align-items-center">
                          <div class="col-auto">
                            <div class="mb-0 mr-3 text-gray-800 h5 font-weight"><strong><?php echo e($student); ?></strong> orang
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="row no-gutters align-items-center">
                      <div class="mr-2 col">
                        <div class="mb-1 text-sm font-weight-bold text-dark text-uppercase">
                          Guru/Dosen</div>
                        <div class="mb-0 text-gray-800 h5 font-weight"><strong><?php echo e($lecturer); ?></strong> orang</div>
                      </div>
                      <div class="col-auto">
                    ...
                    <div class="row no-gutters align-items-center">
                      <div class="mr-2 col">
                        <div class="mb-1 text-sm font-weight-bold text-warning text-uppercase">
                          Peneliti</div>
                        <div class="mb-0 text-gray-800 h5 font-weight"><strong><?php echo e($researcher); ?></strong> orang</div>
                      </div>
                      <div class="col-auto">
                    ...
                    <div class="row no-gutters align-items-center">
                      <div class="mr-2 col">
                        <div class="mb-1 text-sm font-weight-bold text-secondary text-uppercase">
                          Umum</div>
                        <div class="mb-0 text-gray-800 h5 font-weight"><strong><?php echo e($general_job); ?></strong> orang</div>
                      </div>
                      <div class="col-auto">
  ...
  <!-- Vendor JS Files -->
  <script src="<?php echo e(asset('template/assets/vendor/aos/aos.js')); ?>"></script>
  <script src="<?php echo e(asset('template/assets/vendor/bootstrap/js/bootstrap.bundle.min.js')); ?>"></script>
  <script src="<?php echo e(asset('template/assets/vendor/glightbox/js/glightbox.min.js')); ?>"></script>
  <script src="<?php echo e(asset('template/assets/vendor/isotope-layout/isotope.pkgd.min.js')); ?>"></script>
  <script src="<?php echo e(asset('template/assets/vendor/swiper/swiper-bundle.min.js')); ?>"></script>
  <script src="<?php echo e(asset('template/assets/vendor/waypoints/noframework.waypoints.js')); ?>"></script>
  <script src="<?php echo e(asset('template/assets/vendor/php-email-form/validate.js')); ?>"></script>
...
<?php /**PATH C:\Users\BPS KOTA MALANG 5\Documents\AppProject\bukutamu\resources\views/Pengguna/index.blade.php ENDPATH**/ ?>