      ...
      <div class="container">
        <div class="row" data-aos="zoom-in">
          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
            <img src="<?php echo e(asset('template/assets/img/mitra/ppn.png')); ?>" class="img-fluid" alt="">
          </div>

          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
            <img src="<?php echo e(asset('template/assets/img/mitra/kemendagri.png')); ?>" class="img-fluid" alt="">
          </div>

          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
            <img src="<?php echo e(asset('template/assets/img/mitra/kemenkeu.png')); ?>" class="img-fluid" alt="">
          </div>

          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
            <img src="<?php echo e(asset('template/assets/img/mitra/kominfo.png')); ?>" class="img-fluid" alt="">
          </div>

          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
            <img src="<?php echo e(asset('template/assets/img/mitra/kemendes.png')); ?>" class="img-fluid" alt="">
          </div>

          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
            <img src="<?php echo e(asset('template/assets/img/mitra/bps.png')); ?>" class="img-fluid" alt="">
          </div>
...
</html><?php /**PATH C:\xampp\htdocs\bukutamu\resources\views/Pengguna/index.blade.php ENDPATH**/ ?>